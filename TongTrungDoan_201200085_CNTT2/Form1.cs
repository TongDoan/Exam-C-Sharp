...
namespace TongTrungDoan_201200085_CNTT2
{
    public partial class Form1 : Form
    {
        ...
        {
            conectData.Connect();
            DataTable dt = conectData.table("Select * from KhachHang");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if(check())
            {
                string query = $"Insert into KhachHang values(N'{textBox1.Text}',N'{textBox2.Text}',N'{textBox3.Text}',N'{textBox4.Text}')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check())
            { 
                string query = $"Update KhachHang set TenKhach = N'{textBox2.Text}',DiaChi = N'{textBox3.Text}',DienThoai = N'{textBox4.Text}' where MaKhach = N'{textBox1.Text.Trim()}'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
         ...
         == System.Windows.Forms.DialogResult.Yes)
            {
                string query = "delete from KhachHang where MaKhach = '" + s + "'";
                conectData.excute(query);
                Form1_Load(sender, e);
                conectData.closeConnect();
            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            { 
                string query = $"Select * from KhachHang where TenKhach = N'{textBox2.Text.Trim()}'";
                try
                {
